...
function newFunction() {
    ...
    ! function(a, b, c) {
        ...
        g.setStyle = function(a, b, c) {
            ...
            if (b = b.replace(L, M).replace("-", ""), "zIndex" === b)
                ...
                try { R && (d[R + b.slice(0, 1).toUpperCase() + b.slice(1)] = c), d[b] = c; } catch (e) {}
        };
    ...
    ! function(t, i) { "object" == typeof exports && "undefined" != typeof module ? i(exports) : "function" == typeof define && define.amd ? define(["exports"], i) : i(t.L = {}); }(this, function(t) {
        ...
        if ("onselectstart" in document)
            mi = function() { V(window, "selectstart", $); }, fi = function() { q(window, "selectstart", $); };
        else {
        ...
        var en = tn.extend({
            ...
            nn = qe.extend({
                ...
                resetStyle: function(t) { return t.options = i({}, t.defaultOptions), this._setLayerStyle(t, this.options.style), this; },
                setStyle: function(t) { return this.eachLayer(function(i) { this._setLayerStyle(i, t); }, this); },
                _setLayerStyle: function(t, i) { "function" == typeof i && (i = i(t.feature)), t.setStyle && t.setStyle(i); }
            }),
        ...
        Ji && xn.include(vn), Le.include({
            getRenderer: function(t) { var i = t.options.renderer || this._getPaneRenderer(t.options.pane) || this.options.renderer || this._renderer; return i || (i = this._renderer = this.options.preferCanvas && Xt() || Jt()), this.hasLayer(i) || this.addLayer(i), i; },
